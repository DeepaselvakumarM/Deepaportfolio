    ...
    projects: [
      {
        ...
        image: Img1,
        description: 'Library Management System built with React, Node.js, and MongoDB.',
        link: 'https://github.com/DeepaselvakumarM/LMS.git',
        tags: ['React', 'Node.js', 'MongoDB']
      },
      {
        ...
        image: Img2,
        description: 'Food Menu Ordering System built with React and Bootstrap.',
        link: 'https://github.com/DeepaselvakumarM/FoodOrder.git',
        tags: ['React', 'Bootstrap']
      },
      {
        title: 'Clothing E-Commerce Site',
        image: Img3,
        description: 'A modern clothing website built using React with animation and styling libraries.',
        link: 'https://github.com/DeepaselvakumarM/Clothing.git',
        tags: ['React', 'Framer Motion', 'Tailwind']
      }
    ]
